...
namespace VISUALIZADOR2022 {
	...
	/// Resumen de Cola
	/// </summary>
	public ref class Cola : public System::Windows::Forms::Form
	{
	public:
		Cola(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Limpiar->Click += gcnew System::EventHandler(this, &Cola::Limpiar_Click);
			// 
			// txtBuscar
			// 
			...
			this->btnInsertar->Click += gcnew System::EventHandler(this, &Cola::btnInsertar_Click);
			// 
			// txtInsertar
			// 
			...
			this->btnEliminar->Click += gcnew System::EventHandler(this, &Cola::btnEliminar_Click);
			// 
			// btnBuscar
			// 
			...
			this->btnBuscar->Click += gcnew System::EventHandler(this, &Cola::btnBuscar_Click);
			// 
			// panel2
			// 
...
#pragma endregion
	private: System::Void btnInsertar_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		this->verEstructura->LoadAsync("cola.png");
